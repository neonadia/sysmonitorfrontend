...
fontName="Helvetica">Jump to Benchmark Report</link>"""
        ptext2 = """<a name="TABLE2"/><font color="black">Hardware Counts and Models</font>"""
        ptext1 = """<a name="TABLE2"/><font color="black">Cluster Summary</font>"""
        p = Paragraph(ptext, centered)
        ...
        ptext_bm = """<a name="BM_TITLE"/><font color="black" size="16">Benchmark Report</font>"""
        ...
        for data, unit, node, name in zip(benchmark_data,benchmark_unit,benchmark_node,list(benchmark_map.keys())):
            if unit != 'N/A':
                ...
                self.story.append(KeepTogether([draw,spacer,t,spacer,dline,p]))
                self.story.append(PageBreak())
#----------------------------------------------------------------------
